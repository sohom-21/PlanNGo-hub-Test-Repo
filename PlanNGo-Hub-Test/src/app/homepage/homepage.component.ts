...
<ul class="snip1217">
  ...
  <li><a routerLink="/cab" routerLinkActive="active" class="tc" >Search And Book</a></li>
...
<div class="outerdiv">
    ...
    <div class="innerdiv">
      ...
      <div class="div1 eachdiv">
        ...
        <p>“ I was an EMT for many years before I joined the bootcamp. I’ve been looking to make a transition and have heard some people who had an amazing experience here. I signed up for the free intro course and found it
           incredibly fun! I enrolled shortly thereafter. The next 12 weeks was the best - and most grueling - time of my life. Since completing the course, 
            ”</p>
        </div>
      </div>
      <!-- div2 -->
      ...
      <div class="div3 eachdiv">
        ...
        <div class="review">
          ...
          <p>“ Before joining the bootcamp, I’ve never written a line of code.
             ...
             They were very hands-on and I never had to wait long for assistance. It certainly helped me land a job as a full-stack 100% recommend! ”</p>
        </div>
      </div>
      <!-- div4 -->
